...
def dict_values_to_df(dict, columns):
    """
    Takes a dictionary in the form of {key1:value1, key2:value2...} and returins a pandas dataframe where the keys are values are split into individual columns.
    """
    to_list = [(key, value) for key, value in dict.items()]
